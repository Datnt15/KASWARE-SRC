...
KASWARE  v4.2.2 includes bug-fixes and enhancements.

Please read the kasware_readme in the Release Notes folder.

Java JRE 8 runtime is required.
The KASWARE  installer now attempts to validate that Java JRE runtime is 
...
when trying to run KASWARE . This is usually caused by having selected
...
Select the :\Windows\System32 JRE during KASWARE  installation OR
