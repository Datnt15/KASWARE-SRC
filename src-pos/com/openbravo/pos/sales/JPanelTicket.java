   ...
   private double excludeTaxes(String tcid, double dValue) {
    ...
    private void stateTransition(char cTrans) {
        ...
        // START OF BARCODE PARSING
            ...
            *        
            *  KASWARE Retailer instore uses these RULES
...
// KASWARE does not support UPC-A Extended at this time                
...
// END OF BARCODE            
    ...
    private boolean CloseTic2(TicketInfo ticket, Object Ticketext){
                ...
                executeEvent(ticket, Ticketext, "ticket.save");
                        ...
                        try {
                            ...
                            executeEvent(ticket, Ticketext, "ticket.close", 
                                    new ScriptArg("print", true));

                                printTicket(true || warrantyPrint
                                    ? "Printer.Ticket"
...
// calculate taxes
         ...
         CloseTic2(m_oTicket, m_oTicketExt);
        //JOptionPane.showMessageDialog(null, "dmm", "InfoBox: " + "hoicham", JOptionPane.INFORMATION_MESSAGE);
