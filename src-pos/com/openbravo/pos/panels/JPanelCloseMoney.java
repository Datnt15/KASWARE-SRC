...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    // search edit
    public  DataLogicCustomers dlCustomers = null;
    public DataLogicSales m_dlSales;
    public  TicketInfo m_ticket;
    public TicketInfo m_ticketCopy;
    
    public  JTicketsBagTicketBag m_TicketsBagTicketBag;
    public  JPanelTicketEdits m_panelticketedit;
